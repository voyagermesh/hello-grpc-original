...
REPO_ROOT = expandvars("$GOPATH/src/voyagermesh.dev/hello-grpc/_proto")
...
def generate_url_summary():
    ...
    for root, dirnames, filenames in os.walk(REPO_ROOT):
        for filename in fnmatch.filter(filenames, '*.proto'):
            ...
            rel_proto = proto[proto.index('voyagermesh.dev/hello-grpc/_proto') + len('voyagermesh.dev/hello-grpc/_proto'):]
            with open(proto) as f:
                content = f.read()
